...
//					 console.log(n);
					...
					if((-range).toFixed(2) == n)
						...
						LCarr_actualValSorted.splice(0, 1, parseFloat(0.2));
						///$('#minus').hide();
						//$('#plus').hide();
						...
						LC_Updategraph(LColdreadingSorted, LCarr_actualValSorted);	
...
//					console.log(n);
					...
					// $('#minus').show();
					 ...
					 for( var i= 1; i<=(LCarr_actualValSorted.length-2); i++ )
						...
						if(range.toFixed(2) == n)
						{ 
							LCarr_actualValSorted.splice((ArrayLeng - 1), 1, parseFloat(1));
							LCarr_actualValSorted.splice(0, 1, parseFloat(ZeroValue));
							$('#Spanplus').hide();
							 $("#SpanangleVal").val(LCarr_actualValSorted[ArrayLeng - 1 ]);
							 zeroAniVal = 0;
...
//		chart.render();
	...
	function LC_Updategraph(LColdreadingSorted, LCarr_actualValSorted){
		var OldValue = [];
		var StdValue = [];
