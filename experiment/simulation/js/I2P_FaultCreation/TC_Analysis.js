...
//		  {
			  TransmitterDB +=' <div class="successMsg">Congratulations!!! Temperature control system (I/P converter) experiment is completed successfully!! <br/><span id="AnalysisStatus"></span></div>'
